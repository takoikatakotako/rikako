...
// SubmitContact converts echo context to params.
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.POST(baseURL+"/contact", wrapper.SubmitContact)
...
type SubmitContact204Response struct {
}

func (response SubmitContact204Response) VisitSubmitContactResponse(w http.ResponseWriter) error {
	w.WriteHeader(204)
	return nil
}

type SubmitContact400JSONResponse Error

func (response SubmitContact400JSONResponse) VisitSubmitContactResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(400)
...
type SubmitContact500JSONResponse Error

func (response SubmitContact500JSONResponse) VisitSubmitContactResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(500)
...
func (sh *strictHandler) SubmitContact(ctx echo.Context, params SubmitContactParams) error {
	...
	handler := func(ctx echo.Context, request interface{}) (interface{}, error) {
		return sh.ssi.SubmitContact(ctx.Request().Context(), request.(SubmitContactRequestObject))
	}
	for _, middleware := range sh.middlewares {
	...
	if err != nil {
		...
		return validResponse.VisitSubmitContactResponse(ctx.Response())
	} else if response != nil {
		return fmt.Errorf("unexpected response type: %T", response)
	}
	return nil
