...
func (w *ServerInterfaceWrapper) GetApp(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "appSlug", ctx.Param("appSlug"), &appSlug, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
...
func (w *ServerInterfaceWrapper) GetUserProfile(ctx echo.Context) error {
	...
	if valueList, found := headers[http.CanonicalHeaderKey("X-App-Slug")]; found {
		...
		err = runtime.BindStyledParameterWithOptions("simple", "X-App-Slug", valueList[0], &XAppSlug, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: true})
		if err != nil {
