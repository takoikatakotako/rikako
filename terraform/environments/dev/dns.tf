...
# api.dev.rikako.org → API Gateway
...
# image.dev.rikako.org → Image CDN CloudFront
...
# content.dev.rikako.org → Content CDN CloudFront
...
# admin.dev.rikako.org → Admin Frontend CloudFront
