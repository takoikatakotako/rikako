...
![1枚目 起動直後画面](./images/onboarding/01-welcome.png)
...
![2枚目 問題集について説明](./images/onboarding/02-workbook-intro.png)
...
![3枚目 問題集選択画面](./images/onboarding/03-workbook-selection.png)
...
![4枚目 アプリの説明](./images/onboarding/04-app-intro.png)
...
- UI
  - 利用規約に同意するトグルまたはチェックボックス
  - 同意しないと `次へ` を押せない

### UI イメージ
- 同意 UI が主役のシンプルな画面
- 同意済みになるまで CTA は disabled

![5枚目 利用規約への同意](./images/onboarding/05-terms.png)
...
![6枚目 オンボーディング完了](./images/onboarding/06-finish.png)
